...
<p align="center">
  <img src="./src/assets/devlabs_logo.png" alt="DevLabs" width="480" />
</p>

<h1 align="center">🧪 DevLabs</h1>

<p align="center">
  <img src="https://img.shields.io/badge/React-18-61DAFB?logo=react&logoColor=white" alt="React 18" />
  <img src="https://img.shields.io/badge/React%20Router-6-CA4245?logo=reactrouter&logoColor=white" alt="React Router 6" />
  <img src="https://img.shields.io/badge/Framer%20Motion-Animated-0055FF?logo=framer&logoColor=white" alt="Framer Motion" />
  <img src="https://img.shields.io/badge/Tailwind%20CSS-Utility%20First-38BDF8?logo=tailwindcss&logoColor=white" alt="Tailwind CSS" />
  <img src="https://img.shields.io/badge/Vite-Build%20Tool-646CFF?logo=vite&logoColor=white" alt="Vite" />
  <img src="https://img.shields.io/badge/Status-In%20Development-49caa0" alt="Status: In Development" />
</p>

> 🧪 A self-contained, animated, offline course library — pick a language or
> framework, learn by doing, and pick up exactly where you left off.
...
DevLabs is an interactive course platform covering the languages,
frameworks, and tools behind modern web and mobile development — from your
first line of HTML all the way to querying a production database.

It's a single React + Vite app: one shell, many courses, each with
explanations, code samples, and hands-on exercises. Every topic ends in
multiple-choice and code-check exercises, complete with hints and worked
solutions, and the whole UI is animated throughout with **Framer Motion**
so moving between topics, checking an answer, or saving progress all feel
like immediate, visible feedback rather than a page just changing.

## ⚡ Features

- 📚 Structured, ground-up lessons for each course — no assumed background
- 🛠️ Multiple-choice **and** hands-on code exercises after every topic, each with a hint and a full solution
- 💾 Progress saved automatically per course, right in the browser's `localStorage`
- 🎬 Animated throughout with Framer Motion — page transitions, staggered lists, hover/tap feedback, animated hints and results
- 🧭 Sidebar topic navigation with live per-topic progress
- 🖍️ Built-in syntax highlighting for code snippets, no external library
- ♻️ Per-course **Reset progress**, so resetting one course never touches another
...
| `Topbar.jsx`                | The progress bar glides to its new width instead of jumping                             |
| `Sidebar.jsx`               | The active topic row shifts slightly on select/hover                                    |
| `Logo.jsx`                  | Small hover wobble on the mark; a blinking terminal cursor after "Labs" in the wordmark |
| `Landing.jsx` feature icons | 📚 🛠️ 💾 each get their own small hover animation (tilt / wiggle / pop)                 |
| `StatusFooter.jsx`          | A gentle pulse while "compiling…"                                                       |
  ...
  topics: [
    {
      ...
      blocks: [
        {
          h: "Section heading",
          p: "Explanation text.",
          tip: "Optional plain-English aside.",
      ...
      exercises: [
        ...
        },
        {
          ...
          q: "Prompt",
          starter: "",
          checks: [/regex the answer must match/],
          hint: "...",
...
src/
  ...
  main.jsx                  # React entry point, wraps App in BrowserRouter
public/
  devlabs-logo.png          # brand banner used in this README
index.html
tailwind.config.js
vite.config.js
```
